  ...
  data() {
    return {
      ...
      cards: [
        ...
        {
          discription:
            " With Craftsman-style theming and a rustic ambiance, the Grand Californian celebrates the beauty and wonder of the entire state. ",
          name: "Grand adventure",
          img: "/assets/resorts/grand-californian/2.png",
        },
        {
          discription:
